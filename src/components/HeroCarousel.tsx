        ...
        >
            <SwiperSlide>
                <header className="relative max-h-screen h-screen z-0 -mt-16">
                    <Image
                        src="https://uiparadox.co.uk/public/templates/blog-insight/assets/media/hero/hero-banner.png"
                        alt="Hero Banner"
                        layout="fill"
                        objectFit="cover"
                    ...
                    <div className="absolute inset-0 text-white flex flex-col justify-center items-center text-center space-y-6 ">
                        ...
                        <p className="text-lg md:text-xl">This is the description for the hero banner.</p>
                        <button className="bg-yellow-500 text-slate-950 rounded-full py-2 px-6">
                            Read More
                        </button>
                    </div>
                </header>
            ...
            <SwiperSlide>
                <header className="relative max-h-screen h-screen z-0 -mt-16">
                    <Image
                        src="https://uiparadox.co.uk/public/templates/blog-insight/assets/media/hero/hero-banner-2.png"
                        alt="Hero Banner"
                        layout="fill"
                        objectFit="cover"
                        className="absolute inset-0 "
            ...
            <SwiperSlide>
                <header className="relative max-h-screen h-screen z-0 -mt-16">
                    <Image
                        src="https://uiparadox.co.uk/public/templates/blog-insight/assets/media/hero/hero-banner-3.png"
                        alt="Hero Banner"
                        layout="fill"
                        objectFit="cover"
                        className="absolute inset-0 "
